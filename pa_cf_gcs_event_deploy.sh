...
declare -a required_vars=("GEN2" "RUNTIME" "REGION" "SERVICE_ACCOUNT" "CLOUDFUNCTION" "SOURCE" "ENTRY_POINT" "TRIGGER_EVENT_FILTERS" "MEMORY" "TIMEOUT" "PROJECT_ID" "TOPIC_NAME" "IMPERSONATE_SA_MAP" "TARGET_SCOPES" "SA_CREDENTIALS_SECRET_NAME" "CSV_PATTERN_REGEX")
unset_vars=()
...
SET_ENV_VARS="PROJECT_ID=$PROJECT_ID,TOPIC_NAME=$TOPIC_NAME,IMPERSONATE_SA_MAP=$IMPERSONATE_SA_MAP,TARGET_SCOPES=$TARGET_SCOPES,SA_CREDENTIALS_SECRET_NAME=$SA_CREDENTIALS_SECRET_NAME,CSV_PATTERN_REGEX=$CSV_PATTERN_REGEX"

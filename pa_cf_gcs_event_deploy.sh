...
declare -a required_vars=("GEN2" "RUNTIME" "REGION" "SERVICE_ACCOUNT" "CLOUDFUNCTION" "SOURCE" "ENTRY_POINT" "TRIGGER_EVENT_FILTERS" "MEMORY" "TIMEOUT" "PROJECT_ID" "PUBLISH_TOPIC_NAME" "PUBLISH_SA" "TARGET_SCOPES" "SA_CREDENTIALS_SECRET_NAME" "CSV_PATTERN_REGEX")
unset_vars=()
...
SET_ENV_VARS="PROJECT_ID=$PROJECT_ID,PUBLISH_TOPIC_NAME=$PUBLISH_TOPIC_NAME,PUBLISH_SA=$PUBLISH_SA,TARGET_SCOPES=$TARGET_SCOPES,SA_CREDENTIALS_SECRET_NAME=$SA_CREDENTIALS_SECRET_NAME,CSV_PATTERN_REGEX=$CSV_PATTERN_REGEX"

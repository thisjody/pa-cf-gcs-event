 ...
 declare -a required_vars=("GEN2" "RUNTIME" "REGION" "SERVICE_ACCOUNT" "SOURCE" "ENTRY_POINT" "TRIGGER_EVENT_FILTERS" "MEMORY" "TIMEOUT" "PROJECT_ID" "TOPIC_NAME" "IMPERSONATE_SA" "TARGET_SCOPES" "SA_CREDENTIALS_SECRET_NAME")
 unset_vars=()
